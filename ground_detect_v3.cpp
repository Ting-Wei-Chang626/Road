...
Mat Image::compute_first_Homography(Mat a, Mat b){
    ...
    Ptr<xfeatures2d::SURF> surf = cv::xfeatures2d::SURF::create(minHessian);
...
int main(){
    ...
    // frame_1.set_outlier_inlier(frame_0.get_image(), frame_1.get_image(), frame_1.get_homography(), 40);
    ...
    // To define the effective range of error
    double radius = 60;
